...
const ApplicationDoctor = () => {
    ...
    return (
        <div className="relative inline-block text-left w-full">
            {/* ApplicationDoctor Button */}
            <button
                onClick={() => setIsOpen(!isOpen)}
                className="text-white bg-[#116BA3] dark:hover:bg-[#116BA3] focus:ring-4 focus:outline-none focus:ring-blue-300 
                font-medium rounded-lg text-xl px-5 py-2.5 text-center inline-flex items-center 
                 dark:focus:ring-blue-800 w-full justify-between"
            >
                <span>Application For Doctor</span>
                <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                </svg>
            </button>

            {/* ApplicationDoctor Menu with Framer Motion */}
            {isOpen && (
                <motion.div
                ...
                >
                    <ul className="py-2 text-lg w-full flex flex-col gap-2 ">
                        <li className='flex text-2xl m-4 font-semibold'>
                            ...
                            <div className=' text-center w-1/5'>EXP</div>
                            <div className=' text-center w-1/5'>Certificate</div>
                        ...
                        {Array(8).fill(0).map((_, index) => (
                            <li key={index}>
                                <div className='flex text-xl'>
                                    ...
                                    <div className=' text-center w-1/5'>MD Certified</div>
                                    <div className=' text-center w-1/5'>19/09/2005</div>
                                    <div className=' text-center w-1/5'>
                                        <Link href={"/admin/dd121909090505/appldoctor"}>
